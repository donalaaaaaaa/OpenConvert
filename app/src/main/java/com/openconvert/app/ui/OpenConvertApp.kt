...
private fun PdfToImagesScreen(
    ...
    PdfConfigurationScaffold(
        ...
        item {
            PrimaryPdfButton("选择文件夹并导出图片") { folderPicker.launch(null) }
        }
        item { Box(Modifier.fillMaxWidth(), contentAlignment = Alignment.Center) { PrivacyHint() } }
    }
}
...
private fun PdfSplitScreen(
    ...
    PdfConfigurationScaffold(
        ...
        item {
            PrimaryPdfButton("选择文件夹并拆分 PDF") { folderPicker.launch(null) }
        }
        item { Box(Modifier.fillMaxWidth(), contentAlignment = Alignment.Center) { PrivacyHint() } }
    }
}
...
@Composable
private fun PrimaryPdfButton(label: String, onClick: () -> Unit) {
    Button(
        onClick = onClick,
