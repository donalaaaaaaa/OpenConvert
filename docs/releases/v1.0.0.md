...
> 安装步骤见 [`docs/install.md`](../install.md)，限制见 [`docs/known-issues.md`](../known-issues.md)。

<p align="center">
  <img src="../screenshots/01-home.png" width="160" alt="首页" />
  <img src="../screenshots/02-convert.png" width="160" alt="转换" />
  <img src="../screenshots/03-pdf-tools.png" width="160" alt="PDF 工具" />
  <img src="../screenshots/05-complete.png" width="160" alt="完成" />
</p>
...
完整说明：[docs/install.md](../install.md)。
...
完整列表：[docs/known-issues.md](../known-issues.md)。
